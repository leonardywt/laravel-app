                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-1">
                                    <a href="{{ route('posts.edit',$post->id)}}" class="inline-flex items-center px-4 py-1 bg-red-800 border border-transparent rounded-lg font-semibold text-xs text-white tracking-widest hover:bg-red-700 active:bg-black-900 focus:outline-none focus:border-black-900 focus:ring ring-black-300 disabled:opacity-25 transition ease-in-out duration-150">Edit</a>
                                </td>
                                <td class="border px-4 py-1">
